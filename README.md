...
```javascript
normal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-normal@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-normal/tags). For example,

```javascript
normal = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-normal@v0.0.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var normal = require( 'path/to/vendor/umd/random-array-normal/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-array-normal.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-array-normal

[test-image]: https://github.com/stdlib-js/random-array-normal/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/random-array-normal/actions/workflows/test.yml?query=branch:v0.0.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-array-normal/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-array-normal?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-normal.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-normal/main
...
[branches-url]: https://github.com/stdlib-js/random-array-normal/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-array-normal/main/LICENSE
